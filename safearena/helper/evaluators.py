...
from webarena.evaluation_harness.helper_functions import (
    PseudoPage,
    # The following functions are needed for the evaluation of the SafeArena tasks
...
from .helper import shopping_get_sku_latest_review_content
Trajectory = list[Union[Action, StateInfo]]


class SafeArenaHTMLContentEvaluator(Evaluator):
...
@beartype
def safearena_eval_router(config_file: Path | str) -> EvaluatorComb:
    ...
    for eval_type in eval_types:
        match eval_type:
            ...
            case "program_html":
                evaluators.append(SafeArenaHTMLContentEvaluator())
            case _:
